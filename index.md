...
* Developed and maintained a Python Appium Client/Server pytest testing framework for PS4, PS5, Windows, and Web that was utilized by 1000+ of developers and testers
...
* Maintained a crucial PlayStation Network tool in JavaScript with Node.js and MongoDB, processing 100,000+ of calls weekly across API, web, and CLI for development and testing
...
* Developed Selenium automation strategy for PlayStation Direct's checkout system and drove implementation of automated end-to-end tests suite ensuring 100% test coverage with a focus on stability and maintainability
